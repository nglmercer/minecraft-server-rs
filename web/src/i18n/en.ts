...
export const en = {
  ...
  playit: {
    ...
    states: {
      ...
      unsupported: "Unsupported daemon",
      error: "Error",
    },
    accountStates: {
      unknown: "Unknown",
    ...
    connectBeforeTunnel: "Connect the Playit daemon before creating a tunnel.",
    ...
    tunnelsSection: "All tunnels",
    noTunnels: "No tunnels are currently reported by Playit.",
    ...
    deleteTunnelBody: "This removes the tunnel from the Playit daemon.",
