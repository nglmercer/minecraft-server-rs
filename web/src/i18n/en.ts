...
export const en = {
  ...
  backups: {
    ...
    globalRetentionTitle: "Global retention",
    localDefault: "Local • Default",
    globalRetentionHelp: "New servers store backups locally by default for instant, offline restores without external accounts. Retention limits apply to all servers inheriting global settings.",
    maxBackupsLabel: "Maximum backups",
    maxAgeLabel: "Maximum age (days)",
    maxAgePlaceholder: "Disabled",
    retentionHelp: "Whichever limit is reached first trims oldest backups. The newest successful backup is always kept.",
    saveRetention: "Save retention",
    globalRetentionNote: "Applies to all servers using global settings.",
    googleDrive: "Google Drive",
    googleDriveHelp: "Connect Google Drive once globally. Any server can then be switched to Drive in its own backup settings.",
    oauthNotConfigured: "OAuth not configured on server",
    oauthEnvHelp: "Set MCPANEL_GOOGLE_CLIENT_ID and MCPANEL_GOOGLE_CLIENT_SECRET, then restart the panel.",
    oauthRedirectUriHelp: "In Google Cloud Console → OAuth client, add redirect URI:",
    notConnected: "Not connected",
    notConnectedHelp: "Sign in with Google to enable cloud backups. The panel only stores a refresh token.",
    connectGoogle: "Connect Google Drive",
    waitingConsent: "Waiting for consent…",
    testConnection: "Test connection",
    connected: "Connected to Google Drive",
    connectedHelp: "Servers configured for Google Drive will upload using this account.",
    ...
    consentOpened: "Opened Google consent — complete sign-in in the new window",
    connectionOk: "Connection OK",
    perServerTitle: "Backup storage for this server",
    inheritingLocal: "Inheriting • Local",
    local: "Local",
    useGlobal: "Use global settings",
    whyLocalTooltip: "Local backups keep restores instant and work offline. Disable to store backups in Google Drive or customize retention for this server.",
    inheritsSummary: "Inherits: local • keeps {max} backup(s) · {age}",
    maxDays: "max {days} days",
    noAgeLimit: "no age limit",
    providerLabel: "Backup provider",
    providerLocal: "Local — on this machine",
    providerDrive: "Google Drive — cloud",
    driveFolderId: "Google Drive Folder ID",
    driveFolderPlaceholder: "Optional (empty for My Drive root)",
    driveFolderHelp: "All backups for this server go into this folder. Leave empty for root of My Drive, or paste a folder ID from your Drive URL.",
    driveServerTokenHelp: "This server will use the global Google Drive connection.",
    connectFromGlobal: "Connect Google Drive in the global Backups page first.",
    perServerSaved: "Server backup settings saved",
